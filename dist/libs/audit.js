...
function disposeDb(siteName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(resx_1.IoResxManager.instance.items
            .filter(fn => fn.stats.needsNewVersion)
            .map((fn) => __awaiter(this, void 0, void 0, function* () { return insertFileAudit(fn, dbWrapper.on); })));
